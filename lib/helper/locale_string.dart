...
class LocaleString extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    ...
    'en_GB': {
      ...
      'Fill in all fields correctly!': 'Fill in all fields correctly!',
      //
      'Notice': 'Notice',
    ...
    'de_DE': {
      ...
      'Fill in all fields correctly!': 'Füllen Sie alle Felder korrekt aus!',
      //
      'Notice': 'Hinweis',
      'Enter valid date!': 'Gib ein gültiges Datum ein!',
      //
      'January': 'Jänner',
      'February': 'Februar',
      'March': 'März',
    ...
    'fr_FR': {
      ...
      //
      'Notice': 'Avis',
      'Enter valid date!': 'Entrez une date valide!',
      //
      'January': 'Janvier',
      'February': 'Février',
      'March': 'Mars',
      ...
      //
      'NotificationOnAppKillContentTitle': 'Votre alarme peut ne pas sonner!',
      'NotificationOnAppKillContentBody.':
    ...
    'es_ES': {
      ...
      //
      'Notice': 'Aviso',
      'Enter valid date!': 'Ingrese la fecha válida!',
      //
      'January': 'Enero',
      'February': 'Febrero',
      'March': 'Marzo',
      ...
      //
      'NotificationOnAppKillContentTitle': 'Es posible que tu alarma no suene!',
      'NotificationOnAppKillContentBody':
