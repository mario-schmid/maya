...
class _HomeState extends State<DateCalculator> {
  ...
  void calculateAndShowResult(Size size) {
    ...
    try {
      final DateTime chosenDate = DateTime.utc(
      ...
      final daysOfFebruary = year % 4 == 0 && year % 100 != 0 || year % 400 == 0
          ? 29
          : 28;
                    ...
                    child: Column(
                      children: [
                        Container(
                          ...
                          child: Center(
                            child: Text(
                              '${MayaList.strTone[tone]} ${MayaList.strNahual[nahual]}',
                        ...
                        Container(
                          ...
                          child: Center(
                            child: Text(
                              '${intHaabDate[0]} ${MayaList.strWinal[intHaabDate[1]]} $haabYear',
                              style: textStyleResult,
                            ),
                          ),
                        ),
        ...
        builder: (BuildContext context) {
          return Center(
            child: Container(
              ...
              decoration: MayaStyle().popUpDialogDecoration(widget.mainColor),
              height: 93,
              width: size.width + 52,
              child: Column(
