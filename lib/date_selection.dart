                        ...
                        Container(
                          ...
                          child: Center(
                            child: SizedBox(
                              ...
                              child: MayaImage.imageToneWhiteFlatCenter[i],
                            ),
                          ),
                        ),
                    ] else ...[
                  ...
                  children: [
                    for (int i = -108; i < 109; i++)
                      Container(
                        width: size.width * 0.3,
                        decoration: BoxDecoration(
                          image: (widget.chosenYear + i) % 52 == 0
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => TheDay(
          ...
          chosenLongCount: [baktun, katun, tun, winal, kin],
          chosenGregorianDate: widget.chosenGregorianDate.add(
            Duration(days: dDays),
          ),
        ),
      ),
